...
@Client.on_message(filters.private & filters.command(['view_arman_thumb','vat']))
...
@Client.on_message(filters.private & filters.command(['del_arman_thumb','delete_arman_thumb','dat']))
...
@Client.on_message(filters.private & filters.command(['set_arman_thumb','set_arman_thumbnail', 'sat']))
